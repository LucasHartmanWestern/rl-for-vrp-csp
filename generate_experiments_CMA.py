...
num_episodes_options = cma_parameters["max_generations"]["options"]
...
for i in range(latest_experiment, latest_experiment + total_combinations):
    ...
    config["cma_parameters"]["max_generations"] = num_episodes_options[num_episodes_index]
